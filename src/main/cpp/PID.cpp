...
*/
PID::PID(double maximumAllowableError_, double minVelocity_, double maxVelocity_, double minAcceleration_, double maxAcceleration_, double kP_, double kI_, double kIMaxEffect_)
{
...
*/
double PID::Calculate(double error, double elapsedTime)
{
